export default function Season() {
  return (
    <section id="temporada" className="pb-[82px]">
      <div className="container grid gap-[18px] sm:grid-cols-2">
        <div className="min-h-[230px] rounded-[22px] bg-[#E8D8C8] p-[35px]">
          <span className="eyebrow">01 · Busca</span>
          <h2 className="my-[14px] font-display text-[3rem] text-dark">
            Encuentra rápido.
          </h2>
        ...
        <div className="min-h-[230px] rounded-[22px] bg-[#DDE4DA] p-[35px]">
